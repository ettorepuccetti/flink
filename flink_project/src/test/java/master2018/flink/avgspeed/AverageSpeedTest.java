...
public class AverageSpeedTest {
    ...
    public void testAverageSpeed() throws Exception {
        List<Event<Integer,Double>> events = runTest("master2018/flink/avgspeed/avg-speed.csv");
...
//    }
    ...
    private List<Event<Integer,Double>> runTest(String filepath) throws Exception {
    ...
    private static class CollectSink implements SinkFunction<Event<Integer,Double>> {

        // must be static
        public static final List<Event<Integer,Double>> events = new ArrayList<>();
